<template>
  <div class="models-container">
    <div class="title">All Models</div>
    <div class="content">
      <div
        :class="['models', activeModel.id === item.id && 'active-model']"
...
const emits = defineEmits(["update:activeModel"]);

const models = ref([]);
const checkModel = (item) => {
  emits("update:activeModel", item);
};
  ...
  const res = {
    ...
    data: [
      ...
      },
      {
        ...
        permission: [
          {
            id: "modelperm-k88Iyeag7j7VwltZUQhEQgzU",
            object: "model_permission",
            created: 1675913888,
            allow_create_engine: false,
            allow_sampling: true,
...
.title {
  ...
  position: sticky;
  top: 0;
  background: linear-gradient(90deg, #74c7ff, transparent);
  z-index: 2;
}
.content {
  flex: 1;
...
.active-model {
  ...
  box-shadow: 4px 4px 7px rgba(95, 191, 255, 0.26);
}
