  ...
  <div class="bg">
    <div class="chat-container">
      <div class="sider">
        ...
        <div style="margin-top: 20px" class="sider-option">
          <el-icon><ChatLineRound /></el-icon>
        </div>
      </div>
      <ChatModels v-model:activeModel="activeModel"></ChatModels>
      <ChatRoom :activeModel="activeModel"></ChatRoom>
    </div>
  </div>
</template>
